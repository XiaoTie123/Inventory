						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="status"> <spring:message
										code="order.order.status"></spring:message>
								</label> <select class="form-control bg-white" id="orderStatus">
									<option value="-1">ALL</option>
									<c:forEach items="${orderStatusList}" var="s">
...
<script
	src="<%=request.getContextPath()%>/resources/js/order/order-search.js?modified=338332832"></script>